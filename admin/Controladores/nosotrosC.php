...
class NosotrosC{
    ...
    public function VerNosotrosC(){
        ...
        echo'<img src="Vistas/img/defecto.jpg"class="img-thumbnail" width="250px">'; 
    ...
    public function EditarNosotrosC(){
        ...
        $respuesta = NosotrosM::EditarNosotrosModelo($tablaBD, $id);
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <h2>Titulo:</h2>
                <input type="text" class="form-control input-lg" name="tituloE" requiered value="'.$respuesta["titulo"].'"> 
            ...
            <div class="form-group">
                ...
                <h2>Mision:</h2>
              <textarea class="form-control" name="misionE" requiered> '.$respuesta["mision"].'</textarea> 
            ...
            <div class="form-group">
                ...
                <h2>Vision:</h2>
                <textarea class="form-control" name="visionE" requiered> '.$respuesta["vision"].'</textarea>
            ...
            <div class="form-group">
                ...
                if($respuesta["imagen"] != ""){
                    ...
                    echo '<img src="Vistas/img/defecto.jpg"class="img-thumbnail visor" width="270px">';
...
<button class="btn btn-danger" data-dismiss="modal">Cancelar</button>
    ...
    public function  ActualizarNosotrosC(){
        ...
        if(isset($_POST["tituloE"])){
            ...
            $datosC = array("id"=>$_POST["Nid"], "titulo" =>$_POST["tituloE"], "mision"=> $_POST["misionE"], "vision"=>$_POST["visionE"], "imagen"=>$rutaImg);
